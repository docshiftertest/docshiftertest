...
public class ImageUtilsTest {
	...
	private static Stream<Arguments> colorParams() {
		return Stream.of(
				...
				arguments("0000ff", new Color(0, 0, 255)),
				arguments("00FF", new Color(0, 0, 255)),
				arguments("Ff", new Color(0, 0, 255)),
				arguments("#00FF00", new Color(0, 255, 0)),
				arguments("#EE00FF00", new Color(0, 255, 0, 238)),
				arguments("#DeADbEEf", new Color(173, 190, 239, 222)),
				arguments("DEAdBe", new Color(222, 173, 190)),
				arguments("DEADBEEF", new Color(173, 190, 239, 222)),
				arguments("CAFEBABE", new Color(254, 186, 190, 202)),
	...
	private static Stream<String> nonExistingColorParams() {
		return Stream.of(null, "", "    ", "I do not exist", "R ed", "bluee", "#DEADBEEZ", "#DEADBEEF1", "#", "0x",
				"#000000001", "DEADBEEF1", "xCAFEBABE", "0xCAFEBABE1");
	}
}