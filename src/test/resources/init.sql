...
CREATE TABLE GLOBAL_SETTINGS(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,DEFAULT_ERROR_FOLDER VARCHAR(255),DEFAULT_TEMP_FOLDER VARCHAR(255),MQ_QUEUE VARCHAR(255),MQ_SYSTEM VARCHAR(255),MQURL VARCHAR(255),MQ_USER VARCHAR(255),MQ_USER_PASSWORD VARCHAR(255));
...
CREATE TABLE IF NOT EXISTS  MODULE_CONFIGURATION_PARAMETER_VALUES(MODULE_CONFIGURATION_ID BIGINT NOT NULL,PARAMETER_VALUES VARCHAR(2048),PARAMETER_VALUES_KEY BIGINT NOT NULL,PRIMARY KEY(MODULE_CONFIGURATION_ID,PARAMETER_VALUES_KEY),CONSTRAINT FKDJKXLDXH15Y06YBOAI6AS3EE6 FOREIGN KEY(MODULE_CONFIGURATION_ID) REFERENCES DOCSHIFTER.MODULE_CONFIGURATION(ID));
...
CREATE TABLE IF NOT EXISTS  NODE(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,MODULE_CONFIGURATION_ID BIGINT,PARENT_NODE_ID BIGINT,CONSTRAINT FKDPBXB57BGEHLAYQB30GQ252VG FOREIGN KEY(MODULE_CONFIGURATION_ID) REFERENCES DOCSHIFTER.MODULE_CONFIGURATION(ID),CONSTRAINT FK4WJRE833Q4WNFWWTL0YBS3WN7 FOREIGN KEY(PARENT_NODE_ID) REFERENCES DOCSHIFTER.NODE(ID));
...
CREATE TABLE IF NOT EXISTS  MONITORING_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,TYPE VARCHAR(31) NOT NULL,CONFIGURATION_ID BIGINT NOT NULL,CONSTRAINT FK4CH1VQDFNV832WCRXWBR1PWBI FOREIGN KEY(CONFIGURATION_ID) REFERENCES DOCSHIFTER.MONITORING_CONFIGURATION(ID));

CREATE TABLE IF NOT EXISTS  MONITORING_DB_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,CONNECTION VARCHAR(255),DRIVER VARCHAR(255),PASSWORD VARCHAR(255),TABLE_NAME VARCHAR(255),USER VARCHAR(255),CONSTRAINT FK7R4EB56SK328XNDFYXAYQ8SAH FOREIGN KEY(ID) REFERENCES DOCSHIFTER.MONITORING_CONFIG_ITEM(ID));
...
CREATE TABLE IF NOT EXISTS  MONITORING_MAIL_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,SMTP_CONFIGURATION_ID BIGINT,CONSTRAINT FKQ3K1DYQV94RYRMCSPH6L4X4S8 FOREIGN KEY(SMTP_CONFIGURATION_ID) REFERENCES DOCSHIFTER.MONITORING_SMTP_CONFIG(ID),CONSTRAINT FKFN95PYKCX7LPJC9X2JNVVXT6T FOREIGN KEY(ID) REFERENCES DOCSHIFTER.MONITORING_CONFIG_ITEM(ID));
CREATE TABLE IF NOT EXISTS  MONITORING_MAIL_ADDRESS(MAIL_CONFIGURATION_ITEM_ID BIGINT NOT NULL,EMAIL VARCHAR(320) NOT NULL,CONSTRAINT FKMHQRW4X7OCI1BUXGI5V88SY1B FOREIGN KEY(MAIL_CONFIGURATION_ITEM_ID) REFERENCES DOCSHIFTER.MONITORING_MAIL_CONFIG_ITEM(ID));
CREATE TABLE IF NOT EXISTS  MONITORING_MAIL_TEMPLATE(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,BODY VARCHAR(1000),TASK_ID VARCHAR(255),TITLE VARCHAR(998),MAIL_CONFIGURATION_ITEM_ID BIGINT NOT NULL,CONSTRAINT FKM5SONVRK2SBYD62EVTWTOOC4K FOREIGN KEY(MAIL_CONFIGURATION_ITEM_ID) REFERENCES DOCSHIFTER.MONITORING_MAIL_CONFIG_ITEM(ID));
CREATE TABLE IF NOT EXISTS  MONITORING_NOTIFICATION_LEVELS(CONFIGURATION_ITEM_ID BIGINT NOT NULL,LEVEL VARCHAR(255) NOT NULL,PRIMARY KEY(CONFIGURATION_ITEM_ID,LEVEL),CONSTRAINT FK36WMJDP7QKC18MI010U8LFJ0R FOREIGN KEY(CONFIGURATION_ITEM_ID) REFERENCES DOCSHIFTER.MONITORING_CONFIG_ITEM(ID));
CREATE TABLE IF NOT EXISTS  MONITORING_SNMP_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,COMMUNITY VARCHAR(255),IP_ADDRESS VARCHAR(255),PORT INTEGER NOT NULL,TRAP_OID VARCHAR(255),CONSTRAINT FK652HW5IJRUPUG39FSHXXL8JUL FOREIGN KEY(ID) REFERENCES DOCSHIFTER.MONITORING_CONFIG_ITEM(ID));
...
CREATE TABLE IF NOT EXISTS  MONITORING_WEBHOOK_TEMPLATE(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,BODY VARCHAR(1000),TASK_ID VARCHAR(255),WEBHOOK_CONFIGURATION_ITEM_ID BIGINT,CONSTRAINT FKGAD4F35BPR3YOWL3MCVE8GVTA FOREIGN KEY(WEBHOOK_CONFIGURATION_ITEM_ID) REFERENCES DOCSHIFTER.MONITORING_WEBHOOK_CONFIG_ITEM(ID));
CREATE TABLE IF NOT EXISTS  MONITORING_WEBHOOK_URL_PARAMS(WEBHOOK_TEMPLATE_ID BIGINT NOT NULL PRIMARY KEY,VALUE VARCHAR(1000),NAME VARCHAR(255) NOT NULL,CONSTRAINT FKKAPT5H9EMIYDD5V6B8HSJTYTX FOREIGN KEY(WEBHOOK_TEMPLATE_ID) REFERENCES DOCSHIFTER.MONITORING_WEBHOOK_TEMPLATE(ID));
...
DROP TABLE IF EXISTS METRICS.DOCUMENT_COUNTER;
CREATE TABLE IF NOT EXISTS METRICS.DOCUMENT_COUNTER(TASK_ID VARCHAR(255) PRIMARY KEY, COUNTS BIGINT);