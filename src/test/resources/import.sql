...
CREATE TABLE MONITORING_CONFIGURATION(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, NAME VARCHAR(255));
CREATE TABLE MONITORING_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, TYPE VARCHAR(31) NOT NULL, CONFIGURATION_ID BIGINT NOT NULL);
CREATE TABLE MONITORING_DB_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, CONNECTION VARCHAR(255), DRIVER VARCHAR(255), PASSWORD VARCHAR(255), TABLE_NAME VARCHAR(255), DB_USER VARCHAR(255));
CREATE TABLE MONITORING_SMTP_CONFIG(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, FROM_ADDRESS VARCHAR(320), HOST VARCHAR(255), PASSWORD VARCHAR(255), PORT INTEGER NOT NULL, SSL BOOLEAN NOT NULL, USERNAME VARCHAR(320));
CREATE TABLE MONITORING_MAIL_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, SMTP_CONFIGURATION_ID BIGINT);
CREATE TABLE MONITORING_MAIL_ADDRESS(MAIL_CONFIGURATION_ITEM_ID BIGINT NOT NULL, EMAIL VARCHAR(320) NOT NULL);
CREATE TABLE MONITORING_MAIL_TEMPLATE(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, BODY VARCHAR(1000), TASK_ID VARCHAR(255), TITLE VARCHAR(998), MAIL_CONFIGURATION_ITEM_ID BIGINT NOT NULL);
CREATE TABLE MONITORING_NOTIFICATION_LEVELS(CONFIGURATION_ITEM_ID BIGINT NOT NULL, LEVEL VARCHAR(255) NOT NULL, PRIMARY KEY(CONFIGURATION_ITEM_ID, LEVEL));
CREATE TABLE MONITORING_SNMP_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, COMMUNITY VARCHAR(255), IP_ADDRESS VARCHAR(255), PORT INTEGER NOT NULL, TRAP_OID VARCHAR(255));
CREATE TABLE MONITORING_WEBHOOK_CONFIG_ITEM(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, URL VARCHAR(255));
CREATE TABLE MONITORING_WEBHOOK_HEADER_PARAMS(WEBHOOK_TEMPLATE_ID BIGINT NOT NULL PRIMARY KEY, VALUE VARCHAR(1000), NAME VARCHAR(255) NOT NULL);
CREATE TABLE MONITORING_WEBHOOK_TEMPLATE(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, BODY VARCHAR(1000), TASK_ID VARCHAR(255), WEBHOOK_CONFIGURATION_ITEM_ID BIGINT);
CREATE TABLE MONITORING_WEBHOOK_URL_PARAMS(WEBHOOK_TEMPLATE_ID BIGINT NOT NULL PRIMARY KEY, VALUE VARCHAR(1000), NAME VARCHAR(255) NOT NULL);
