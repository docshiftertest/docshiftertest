...
public class dbTest {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			Module mRoot=new Module(1, "", "", "root", "input", null);
			Module m01=new Module(2, "", "", "c1", "input", null);
			Module m11=new Module(3, "", "", "cc1", "input", null);
			Module m02=new Module(4, "", "", "c2", "input", null);
