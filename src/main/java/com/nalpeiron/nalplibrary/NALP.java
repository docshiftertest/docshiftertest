...
public class NALP {
	 ...
	 */
	public int
	callNalpLibOpen(boolean NSAEnable, boolean NSLEnable, int LogLevel, String WorkDir, String clientName,
		...
		if (!clientName.equals("")) {
			xmlParams = xmlParams + "<ClientName>" + clientName + "</ClientName>";
		}
		...
		if (i < 0) {
			log.error("Could not open licensing library correctly. Error code {}: {}", i, callNalpGetErrorMsg(i));
		}
	...
	/**
	 * Shuts down the library. THIS FUNCTION MUST BE CALLED IMMEDIATELY
