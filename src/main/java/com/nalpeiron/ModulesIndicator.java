...
public enum ModulesIndicator {
    ...
    ALL_TO_IMAGE(               "T0001", "All to Image Transformation",                     "Convert to Image Formats"),
    ALL_TO_PDF(                 "T0002", "All to PDF Transformation",                       "Format Refresh Conversion"),
    AUDIO(                      "T0003", "Audio Transformation",                            "Audio Conversion"),
    CELLS(                      "T0004", "Cells Transformation",                            ""),
    DIAGRAM(                    "T0005", "Diagram Transformation",                          ""),
    DOC_GEN(                    "T0006", "Document Generator for MS-WORD template file",    "Document Generation"),
    EMAIL(                      "T0007", "Email Transformation",                            "Advanced Email Handling"),
    EPUB(                       "T0008", "Epub Transformation",                             ""),
    HIFI(                       "T0009", "HiFi Transformation",                             "High Fidelity PDF Conversion"),
    PNG(                        "T0010", "Image to Png Transformation",                     ""),
    TIFF(                       "T0011", "Image to Tiff Transformation",                    ""),
    PDFA(                       "T0012", "PDFA Transformation",                             "PDF/A Conversion"),
    INDEX(                      "T0013", "Index Transformation",                            ""),
    MERGE(                      "T0014", "Merge Transformation",                            "Merge Content"),
    OCR(                        "T0015", "OCR Operation",                                   "OCR"),
    PDF(                        "T0016", "PDF Transformation",                              "Pdf Conversion"),
    PDF_OPTIMIZATION(           "T0017", "PDF Optimization",                                "PDF Optimization"),
    PDF_OVERLAY(                "T0018", "PDF Overlay Transformation",                      "Overlay (Image and Text)"),
    PDF_SECURITY(               "T0019", "PDF Security Transformation",                     "PDF Security"),
    ...
    THUMBNAIL(                  "T0023", "Thumbnail Transformation",                        "Thumbnail Creation"),
    UNZIPPER(                   "T0024", "Unzip operation",                                 "Unzip"),
    ...
    VIDEO(                      "T0028", "Video Transformation",                            "Video Conversion"),
    WORDS(                      "T0029", "Words Transformation",                            ""),
    XML_DATA_LOAD(              "T0030", "XML Data Load",                                   "XML Data Load"),
    ...
    COUNT_PAGES(                "T0037", "Count Pages Transformation",                      "Count Pages"),
    SANTANDER_XML_FAC_XML(      "T0038", "SantanderXmlFacXmlTransform Operation",           ""),
    NOP(                        "T0039", "No Operation",                                    ""),
    TOC(                        "T0040", "Table of Contents Generator",                     "Table of Contents Creation"),
    ...
    CAD(                        "T0045", "Cad Transformation",                              "CAD Conversion"),
    HTML(                       "T0046", "Html Transformation",                             ""),
    SPLITTER(                   "T0047", "Splitter Transformation",                         "Split Content"),
    COVER_PAGE(                 "T0048", "Cover Page Transformation",                       "Cover Page Creation"),
    BARCODE_READER(             "T0049", "Barcode Reader Transformation",                   "Barcode Reader"),
    ...
    ModulesIndicator(String id, String operation, String productName) {
        this.id = id;
