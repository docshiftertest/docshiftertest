...
public class AuditTrailConfiguration {
    ...
    public Javers javers() {
        ConnectionProvider connectionProvider = () -> DataSourceUtils.getConnection(DataSourceBuilder.create().url("jdbc:postgresql://localhost:5432/audit").password("DS_USER").username("ds_user").build());
